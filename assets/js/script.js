...
const projects = [
    ...
    { name: "Student Record", path: "./Project - 33" ,image: "assets/images/project33.png", description: "Student records Management"},
];
...
function setTheme(theme) {
    ...
    switch (theme) {
        case 'theme1':
            root.style.setProperty('--bg-color', '#f4f7f9');
            root.style.setProperty('--card-bg-color', '#fff8e6');
            root.style.setProperty('--card-accent-color', '#ffda79');
            root.style.setProperty('--text-color', '#333');
            root.style.setProperty('--navbar-bg-color', 'rgba(51, 51, 51, 0.7)');
            break;
        case 'theme2':
            root.style.setProperty('--bg-color', '#e6f7ff');
            root.style.setProperty('--card-bg-color', '#d6eaff');
            root.style.setProperty('--card-accent-color', '#79d2ff');
            root.style.setProperty('--text-color', '#333');
            root.style.setProperty('--navbar-bg-color', 'rgba(0, 102, 153, 0.7)');
            break;
        case 'theme3':
            root.style.setProperty('--bg-color', '#e6ffe6');
            root.style.setProperty('--card-bg-color', '#e0ffe0');
            root.style.setProperty('--card-accent-color', '#a4d279');
            root.style.setProperty('--text-color', '#333');
            root.style.setProperty('--navbar-bg-color', 'rgba(51, 102, 51, 0.7)');
            break;
        case 'theme4':
            root.style.setProperty('--bg-color', '#f9e6ff');
            root.style.setProperty('--card-bg-color', '#f4d6ff');
            root.style.setProperty('--card-accent-color', '#d279ff');
            root.style.setProperty('--text-color', '#333');
            root.style.setProperty('--navbar-bg-color', 'rgba(102, 51, 153, 0.7)');
            break;
        case 'theme5':
            root.style.setProperty('--bg-color', '#ffe6e6');
            root.style.setProperty('--card-bg-color', '#ffd6d6');
            root.style.setProperty('--card-accent-color', '#ff7979');
            root.style.setProperty('--text-color', '#333');
            root.style.setProperty('--navbar-bg-color', 'rgba(153, 51, 51, 0.7)');
            break;
        default:
            break;
    }
